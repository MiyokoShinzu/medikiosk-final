                        ...
                        data.forEach(item => {
                            text += `
                              <tr data-id="${item.id}">
                                ...
                                <button class="btn btn-sm btn-outline-success btn-save d-none"><i class="bi bi-check-lg"></i></button>
                                <button class="btn btn-sm btn-outline-secondary btn-cancel d-none ms-1"><i class="bi bi-x-lg"></i></button>
